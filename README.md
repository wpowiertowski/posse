...
[![CI](https://github.com/wpowiertowski/posse/actions/workflows/ci.yml/badge.svg)](https://github.com/wpowiertowski/posse/actions/workflows/ci.yml)

POSSE (Publish Own Site, Syndicate Elsewhere) is a small Python project that synchronizes Ghost blog posts with social profiles (e.g., Mastodon, Bluesky). The repository uses a src-layout and is built with Docker.
